...
pen.hideturtle()
pen.goto(0, 210)
pen.write("Score: 0  High Score: 0",align="center",font=("Comic Sans MS",15,"bold"))
...
while True:
    ...
    if(wall_collision()==True):
        ...
        delay=0.1
        pen.clear()
        pen.write("Score: {}  High Score: {}".format(score, hscore), align="center",font=("Comic Sans MS",15,"bold")) 
    ...
    if head.distance(food) < 20:
        ...
        if score>hscore:
            high_score=score
        pen.clear()
        pen.write("Score: {}  High Score: {}".format(score, high_score), align="center",font=("Comic Sans MS",15,"bold")) 
